      ...
      {cinematic && (
        ...
        >
          ...
          <div className="absolute inset-x-0 top-[11%] flex flex-col items-center gap-1 px-6 text-center">
            ...
            {/* Readability over restraint: at 11px/60% this sat on a bright
                board and was the one line in the card you could not read. It
                names who did it, which is the part worth carrying. */}
