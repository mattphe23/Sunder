...
// ---------- v19: preset gallery — pre-rolled themed tribes to remix ----------

export interface ForgePreset {
  id: string;
  title: string;      // gallery card title
  blurb: string;      // one-line theme description
  config: CustomTribeConfig;
}

/** Curated starting points; "remix" loads one into the forge for editing. */
export const FORGE_PRESETS: ForgePreset[] = [
  {
    id: "emberguard",
    title: "The Emberguard",
    blurb: "Forge-tempered shock troops — hit first, hit harder.",
    config: { name: "Emberguard", color: "#f97316", passive: "forgeborn", uniqueUnit: "berserker", startTech: "hunting" },
  },
  {
    id: "mistveil",
    title: "The Mistveil",
    blurb: "Scholars of the deep archives — out-research everyone.",
    config: { name: "Mistveil", color: "#6366f1", passive: "scholars", uniqueUnit: "arcanist", startTech: "organization" },
  },
  {
    id: "saltborn",
    title: "The Saltborn",
    blurb: "Storm-riding corsairs — the sea is a highway, not a wall.",
    config: { name: "Saltborn", color: "#06b6d4", passive: "tideborn", uniqueUnit: "tidecaller", startTech: "sailing" },
  },
  {
    id: "greenwardens",
    title: "The Greenwardens",
    blurb: "Swift woodland outriders — claim ground before rivals wake.",
    config: { name: "Greenwardens", color: "#84cc16", passive: "outriders", uniqueUnit: "raider", startTech: "riding" },
  },
];
